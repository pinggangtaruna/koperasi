            ...
            <div class="col">
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Form Transaksi Service</h3>
                    ...
                    <div class="card-body">
                        <form action="<?= base_url('bengkel/tambah-service'); ?>" method="post" id="form-tambah-service">
                            ...
                            <div class="col text-right">
                                <button id="tambah-service" type="button" class="btn btn-success">Submit</button>
                            </div>
                    </div>
                    <!-- /.card-body -->
                </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="col text-right">
                    <button type="button" id="secure2" class="btn btn-success">Submit</button>
                </div>
                </form>
            </div>
        </div>
