        ...
        <div class="row">
            <div class="col">
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <form action="<?= base_url('pengolahan/tambah-kirim'); ?>" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <select id="tujuan" name="tujuan" class="form-control custom-select">
                                    ...
                                    <option value="UD PD Jaya">UD PD Jaya</option>
                                    <option value="UD Eka Jaya">UD Eka Jaya</option>
                                    <option value="UD Dewa laut">UD Dewa laut</option>
                                    <option value="UD Sumber Jaya">UD Sumber Jaya</option>
                                    <option value="UD Kuda Laut">UD Kuda Laut</option>
                                    <option value="UD Halmahera">UD Halmahera</option>
                                    <option value="UD Jaya Baru">UD Jaya Baru</option>
                                </select>
